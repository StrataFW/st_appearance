...
import {
	...
	TbPalette, TbBookmark, TbHanger, TbCamera, TbRun,
	TbLayoutSidebarLeftCollapse, TbLayoutSidebarLeftExpand,
	TbUser, TbWalk, TbDeviceWatch, TbHistory, TbDoorEnter,
} from "react-icons/tb";
...
const useStyles = createStyles((theme, { collapsed }: { collapsed: boolean }) => ({
	...
	brand: {
		padding: "clamp(12px, 0.85vw, 18px) clamp(10px, 0.6vw, 14px)",
	...
	return (
		<Box className={classes.sidebar}>
			<Box className={classes.brand}>
				<Logo wordmark={!collapsed} size="md" tagline={!collapsed ? "Appearance" : undefined} />
			</Box>
